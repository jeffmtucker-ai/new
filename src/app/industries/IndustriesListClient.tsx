    ...
    <>
      ...
      <section className="relative pt-32 pb-20 bg-slate-900 overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            From <Link href="/industries/plumber-marketing" className="text-teal-400 underline underline-offset-2 hover:text-teal-300">plumbers</Link> and <Link href="/industries/dental-practice-marketing" className="text-teal-400 underline underline-offset-2 hover:text-teal-300">dentists</Link> to <Link href="/industries/personal-injury-law-firm-marketing" className="text-teal-400 underline underline-offset-2 hover:text-teal-300">law firms</Link> and <Link href="/industries/ecommerce-business-marketing" className="text-teal-400 underline underline-offset-2 hover:text-teal-300">e-commerce</Link> — if people search for it, we dominate it. Every industry page includes a custom strategy breakdown, keyword opportunities, and what to realistically expect.
          </motion.p>
