    ...
    <>
          ...
          <div className="grid lg:grid-cols-[1fr_340px] gap-12">
            <div className="prose prose-slate max-w-none">
              ...
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.1 }} variants={fadeUp} transition={{ duration: 0.5, delay: 0.1 }}>
                ...
                <p className="text-slate-600 leading-relaxed mb-6">
                  How many leads does your {lb} business lose because you didn&apos;t respond fast enough? Studies show businesses that respond to leads within 5 minutes are <strong>100x more likely to make contact</strong> than those that wait 30 minutes. Our <L href="/ai">AI automation</L> responds in under 10 seconds — 24 hours a day, 7 days a week.
                </p>
                <p className="text-slate-600 leading-relaxed mb-6">
                ...
                <p className="text-slate-600 leading-relaxed mb-6">
                  AI automation is built on real infrastructure — <strong>Claude AI</strong> for intelligence, <strong>Telnyx</strong> for SMS, <strong>Supabase</strong> for data. Not a chatbot widget. Not a plugin. A custom-built system that you own. <L href="/ai">See how it works</L> or call <a href={PHONE_HREF} className="text-teal-600 hover:text-teal-700 underline underline-offset-2 font-medium">{PHONE}</a> for a live demo.
                </p>
              </motion.div>
            </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {topAreas.map((area) => (
              <Link key={area.slug} href={`/industries/${industry.slug}/${serviceCategories[0].slug}/${area.slug}`} className="rounded-full bg-slate-100 border border-slate-200 hover:border-teal-400 hover:bg-teal-50 px-5 py-2.5 text-slate-700 hover:text-teal-700 text-sm font-medium transition-all">
                {area.name}
              </Link>
            ))}
          </div>
          <div className="text-center mt-8">
            <Link href="/areas" className="text-teal-600 hover:text-teal-700 text-sm font-semibold underline underline-offset-2 font-cta">
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {relatedIndustries.map((ri, i) => (
              <motion.div key={ri.slug} initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} transition={{ duration: 0.3, delay: i * 0.03 }}>
                <Link href={`/industries/${ri.slug}`} className="group block rounded-xl bg-white border border-slate-200 hover:border-teal-400 p-4 transition-all shadow-sm hover:shadow-md">
          ...
          <div className="text-center mt-8">
            <Link href="/industries" className="text-teal-600 hover:text-teal-700 text-sm font-semibold underline underline-offset-2 font-cta">
