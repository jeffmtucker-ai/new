...
export async function generateMetadata({
  ...
  const canonical = `https://consortiumnyc.com/industries/${ind.slug}/${svc.slug}/${area.slug}`;
...
export default async function ServiceIndustryAreaPage({
  ...
  const pageUrl = `https://consortiumnyc.com/industries/${ind.slug}/${svc.slug}/${area.slug}`;

  const breadcrumbs = [
    { name: "Home", url: "https://consortiumnyc.com" },
    { name: "Industries", url: "https://consortiumnyc.com/industries" },
    { name: ind.badge, url: `https://consortiumnyc.com/industries/${ind.slug}` },
    { name: svc.name, url: `https://consortiumnyc.com/services/${svc.slug}` },
