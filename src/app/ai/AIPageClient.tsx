...
/* ── Use cases ────────────────────────────────────────────────── */
const useCases = [
  { industry: "Plumbing", example: "Customer texts about a leaking pipe at 11pm. AI qualifies the emergency, collects address, and books a morning appointment — all before the plumber wakes up.", href: "/industries/plumber-marketing" },
  { industry: "Dental", example: "New patient fills out a form on Saturday. AI responds in 8 seconds, confirms insurance, and books a cleaning for Monday. By the time the office opens, the appointment is set.", href: "/industries/dental-practice-marketing" },
  { industry: "HVAC", example: "AC breaks in July. Homeowner texts your number. AI confirms the issue, checks your schedule, and books a same-day service call. Lead captured while competitors are at voicemail.", href: "/industries/hvac-company-marketing" },
  { industry: "Law Firm", example: "Accident victim searches for a lawyer at midnight. Fills out your form. AI responds, collects case details, and schedules a consultation. You wake up with a qualified lead and full context.", href: "/industries/personal-injury-law-firm-marketing" },
  { industry: "Med Spa", example: "Patient interested in Botox fills out a form after seeing your Instagram ad. AI answers pricing questions, explains the process, and books a consultation — all via text.", href: "/industries/plastic-surgery-med-spa-marketing" },
  { industry: "Real Estate", example: "Buyer inquires about a listing at 9pm. AI sends property details, asks about budget and timeline, qualifies the buyer, and schedules a showing. Your competition is still checking email Monday morning.", href: "/industries/real-estate-agent-marketing" },
];
      ...
      <section className="py-20 bg-slate-900">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-10">
            <Link href="/industries" className="text-teal-400 hover:text-teal-300 text-sm font-semibold underline underline-offset-2 font-cta">
