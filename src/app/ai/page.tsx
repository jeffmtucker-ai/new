...
export const metadata = {
  ...
  alternates: { canonical: "https://consortiumnyc.com/ai" },
  keywords: [
  ...
  openGraph: {
    ...
    url: "https://consortiumnyc.com/ai",
...
const breadcrumbs = [
  ...
  { name: "AI Automation", url: "https://consortiumnyc.com/ai" },
];
...
export default function AIPage() {
  const pageUrl = "https://consortiumnyc.com/ai";
  return (
    <>
