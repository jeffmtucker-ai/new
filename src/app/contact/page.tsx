...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://consortiumnyc.com/contact" },
  keywords: [
  ...
  openGraph: {
    ...
    url: "https://consortiumnyc.com/contact",
    ...
    <>
      <JsonLd
        data={webPageSchema(
          ...
          "Get in touch with Consortium NYC. Schedule a free strategy consultation for SEO, web design, branding, and digital marketing in NYC, Long Island, and Westchester. Call (212) 202-9220.",
          "https://consortiumnyc.com/contact"
        )}
      />
      <JsonLd
        data={breadcrumbSchema([
          { name: "Home", url: "https://consortiumnyc.com" },
          { name: "Contact", url: "https://consortiumnyc.com/contact" },
        ])}
      />
      <ContactPageClient />
    </>
