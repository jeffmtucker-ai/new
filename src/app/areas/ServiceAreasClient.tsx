      ...
      <section className="py-20 bg-teal-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-slate-600 text-lg max-w-2xl mx-auto">
              A homeowner searching for an <Link href="/industries/hvac-company-marketing" className="text-teal-600 underline underline-offset-2 hover:text-teal-700">HVAC company in Queens</Link> behaves differently than one in <Link href="/areas/westchester-marketing-company" className="text-teal-600 underline underline-offset-2 hover:text-teal-700">Westchester</Link>. We build custom strategies for each.
            </p>
          </motion.div>
