        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32">
          ...
          >
            ...
            <p className="text-slate-300 text-lg sm:text-xl max-w-3xl mx-auto mb-4">
              Local <L href="/nyc-marketing-company-services-list">SEO</L>, <L href="/nyc-marketing-company-services-list">web design</L>, <L href="/nyc-marketing-company-services-list">branding</L>, and <L href="/ai">AI automation</L> for businesses in {area.name}. We know this market. We know the competition. We know how to get you to page one.
            </p>
          ...
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-start">
            ...
            >
              ...
              <div className="space-y-4 text-slate-600 leading-relaxed">
                <p>
                  When someone in {area.name} searches for a <L href="/industries/plumber-marketing">plumber</L>, <L href="/industries/dental-practice-marketing">dentist</L>, <L href="/industries/restaurant-food-service-marketing">restaurant</L>, or <L href="/industries/law-firm-marketing">lawyer</L> — they&apos;re not browsing. They&apos;re ready to buy. The business that shows up first gets the call. If that&apos;s not you, it&apos;s your competitor down the block.
                </p>
                <p>
      ...
      <section className="py-20 sm:py-28 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 mb-4 font-heading">
              Marketing for <L href="/industries">100+ Industries</L> in{" "}
              <span className="text-teal-600">{area.name}</span>
            </h2>
            <p className="text-slate-600 max-w-2xl mx-auto">
              From <L href="/industries/plumber-marketing">plumbers</L> to <L href="/industries/law-firm-marketing">law firms</L>, <L href="/industries/dental-practice-marketing">dental practices</L> to <L href="/industries/restaurant-food-service-marketing">restaurants</L> — we&apos;ve driven results for every type of business in the {regionLabel} market.
            </p>
          </motion.div>
