...
export const metadata: Metadata = {
  ...
  description:
    "Local SEO and national SEO require completely different strategies. Learn which approach drives the most revenue for your NYC business — or if you need both.",
};
    ...
    <>
      <section className="pt-32 pb-12 bg-slate-900">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <Link href="/blog" className="text-teal-400 text-sm font-semibold hover:underline font-cta">
            &larr; Back to Blog
          </Link>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row gap-12">
          ...
          <article className="flex-1 min-w-0 max-w-none">
            ...
            <p className="text-slate-600 leading-relaxed mb-6">
              Here&apos;s the simple test: if your customers walk through a door, call for a service, or need someone physically present — you need local SEO. That means <Link href="/industries/plumber-marketing" className="text-teal-600 underline underline-offset-2 hover:text-teal-700">plumbers</Link>, <Link href="/industries/dental-practice-marketing" className="text-teal-600 underline underline-offset-2 hover:text-teal-700">dentists</Link>, <Link href="/industries/restaurant-food-service-marketing" className="text-teal-600 underline underline-offset-2 hover:text-teal-700">restaurants</Link>, <Link href="/industries/personal-injury-law-firm-marketing" className="text-teal-600 underline underline-offset-2 hover:text-teal-700">law firms</Link>, <Link href="/industries/hvac-company-marketing" className="text-teal-600 underline underline-offset-2 hover:text-teal-700">HVAC companies</Link>, and virtually every service business in the five boroughs.
            </p>
            <p className="text-slate-600 leading-relaxed mb-6">
