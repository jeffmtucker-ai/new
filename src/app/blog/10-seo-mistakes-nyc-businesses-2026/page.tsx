...
export const metadata: Metadata = {
  ...
  description:
    "The most common SEO mistakes we see NYC businesses making — and exactly how to fix them. From local citations to Core Web Vitals, stop leaving money on the table.",
};
          ...
          <article className="flex-1 min-w-0 max-w-none">
            ...
            <div className="mt-12 p-8 rounded-xl bg-teal-50 border border-teal-100">
              ...
              <p className="text-slate-600 text-sm mb-4">
                Get a <Link href="/free-seo-audit" className="text-teal-600 underline underline-offset-2 hover:text-teal-700">free SEO audit</Link> and we&apos;ll tell you exactly where you stand — no sales pitch, no obligation.
              </p>
              <Link
                href="/free-seo-audit"
