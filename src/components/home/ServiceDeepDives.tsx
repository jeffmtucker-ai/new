...
> = {
  ...
  "brand-strategy-identity-in-nyc": {
    ...
    paragraphs: [
      <span key="brand1">When a homeowner needs a <L href="/industries/plumber-marketing">plumber</L> or a patient needs a <L href="/industries/dental-practice-marketing">dentist</L>, they pick the business that looks the most trustworthy and professional. Your brand is the reason someone picks you over the competitor down the block. We build brands for <L href="/industries">100+ industries</L> that cut through noise — visual identities, messaging, and brand voices that make customers stop scrolling and start calling.</span>,
      <span key="brand2">Our <L href="/nyc-marketing-company-services-list">branding process</L> starts with strategy, not aesthetics. We dig into your local market positioning, your competitive landscape, and what your customers actually care about before we touch a single design file. The result is a brand identity that communicates trust instantly — whether someone finds you on Google, sees your truck, or visits your <L href="/nyc-marketing-company-services-list">website</L>. For local businesses in <L href="/areas">NYC, Long Island, and Westchester</L>, a strong brand is the foundation of every other marketing effort.</span>,
  ...
  "business-strategy-consulting-in-nyc": {
    ...
    paragraphs: [
      <span key="strat1">Most agencies skip strategy and jump straight to tactics. That&apos;s why most agencies fail. We start every engagement with deep local market research — analyzing the other <L href="/industries/plumber-marketing">plumbers</L>, <L href="/industries/dental-practice-marketing">dentists</L>, or <L href="/industries/restaurant-food-service-marketing">restaurants</L> in your area, mapping how your customers search, and building a roadmap that turns your marketing dollars into real leads. No guesswork. No gut feelings. Just data from your actual market.</span>,
      <span key="strat2">The <L href="/areas">NYC metro area</L> is uniquely complex. A homeowner searching for <L href="/industries/hvac-company-marketing">HVAC repair in Queens</L> behaves differently than one in <L href="/areas">Westchester</L>. A <L href="/industries/restaurant-food-service-marketing">restaurant in Brooklyn</L> faces different competition than one on <L href="/areas">Long Island</L>. Our strategies account for these nuances with hyper-targeted approaches for each neighborhood and market segment. We develop custom KPIs that map directly to your business goals — not vanity metrics.</span>,
      <span key="strat3">Digital strategy is the connective tissue between all our <L href="/nyc-marketing-company-services-list">services</L>. It determines which local keywords drive the most calls, how your website should convert visitors, and where <L href="/ai">AI automation</L> can save you time. Without strategy, you&apos;re just throwing money at tactics and hoping something sticks. See our <L href="/nyc-marketing-pricing-guide">transparent pricing</L> or <L href="/contact-nyc-marketing-company-consortium-nyc">schedule a strategy session</L>.</span>,
    ],
  },
  "marketing-manager-consulting-in-nyc": {
    headline: "Your Outsourced Marketing Department",
    paragraphs: [
      <span key="mgr1">Traffic without a system to capture and convert it is wasted traffic. We build lead capture systems for <L href="/industries/home-service-business-marketing">home service businesses</L>, <L href="/industries/hvac-company-marketing">HVAC companies</L>, <L href="/industries/dental-practice-marketing">dental practices</L>, <L href="/industries/landscaping-company-marketing">landscapers</L>, <L href="/industries/law-firm-marketing">law firms</L> — that turn website visitors into phone calls, form submissions, and booked appointments. Every lead gets captured and routed to you at exactly the right moment.</span>,
      <span key="mgr2">For <L href="/industries">service businesses</L> across <L href="/areas">NYC, Long Island, and Westchester</L>, we&apos;ve built systems that generate consistent new customers month after month. Landing pages optimized for your specific services and neighborhoods, follow-up sequences that build trust, and simple CRM workflows that make sure no lead falls through the cracks. You focus on doing the work — we make sure the phone keeps ringing.</span>,
  ...
  "analytics-technology-in-nyc": {
    ...
    paragraphs: [
      <span key="auto1">You didn&apos;t start your <L href="/industries/plumber-marketing">plumbing company</L>, <L href="/industries/dental-practice-marketing">dental practice</L>, or <L href="/industries/restaurant-food-service-marketing">restaurant</L> to spend your days chasing leads and sending follow-up emails. Our <L href="/ai">AI automation systems</L> handle lead follow-up, appointment scheduling, review requests, and workflow management — so you can focus on serving customers. We&apos;ve saved local business owners over 20 hours per week with intelligent automation that runs 24/7.</span>,
      <span key="auto2">When a potential customer fills out your contact form or requests a quote, automation kicks in immediately — sending a confirmation, notifying your team, and following up if they don&apos;t respond. No more lost leads because you were on a job site or with a patient. For busy <L href="/industries">local business owners</L> across <L href="/areas">NYC and Long Island</L> who can&apos;t be glued to their phone all day, this is a game-changer.</span>,
      <span key="auto3"><L href="/ai">AI automation</L> is the force multiplier for every other service. Your <L href="/nyc-marketing-company-services-list">SEO</L> generates leads — automation follows up. Your <L href="/nyc-marketing-company-services-list">website</L> captures information — automation routes it to you instantly. This is how small local businesses compete with big chains without hiring a big staff. See <L href="/nyc-marketing-pricing-guide">what it costs</L> or <L href="/contact-nyc-marketing-company-consortium-nyc">talk to us about automation</L>.</span>,
    ],
  },
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-slate-600 text-lg max-w-3xl mx-auto">
            Every service is designed to amplify the others. <L href="/nyc-marketing-company-services-list">SEO</L> feeds your website. Your website feeds your pipeline. Your pipeline feeds your revenue. See how our <L href="/nyc-marketing-pricing-guide">marketing packages</L> work together or explore <L href="/industries">100+ industries we serve</L>.
          </p>
        </motion.div>
