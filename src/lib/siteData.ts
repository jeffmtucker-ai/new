...
export const testimonials = [
  ...
  },
  {
    ...
    text: "We switched to Consortium from another agency and the difference was night and day. Our rankings improved within weeks and the leads haven't stopped since.",
    rating: 5,
  },
  {
    name: "David Chen",
  ...
  },
  {
    ...
    text: "After years of wasting money on agencies that overpromised, Consortium actually delivered. Transparent, responsive, and the SEO results speak for themselves.",
    rating: 5,
  },
  {
    name: "Lisa Park",
    business: "Jersey City, NJ",
    text: "The team at Consortium is incredibly responsive. They treat our business like their own. Our web traffic has tripled and we're getting calls every single day now.",
    rating: 5,
  },
  {
    name: "James O'Brien",
